...
class Uniswap_handler:
    def __init__(self):
        self.prices = self.get_uniswap_prices()
    ...
    def get_uniswap_prices(self):
        uniswap_hourly_prices = self.read_uniswap_prices_to_csv()
        ...
        for item in latest_uniswap_prices:
            ...
            built_dict = {
                ...
                , "hexDay": self.convert_timestamp_to_hex_day(item['hourStartUnix'])
                , "close": close
                , "open": close
                , "high": close
                , "low": close
        ...
        self.write_uniswap_prices_to_csv(uniswap_data)  # 1611212400
